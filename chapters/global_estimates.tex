...
where $E_{rest}$ is the particle rest energy ($\approx 5.1\E{5}$ eV for an electron).
...
\begin{figure}[h]
\begin{center}
\includegraphics[draft]{figures/test_particle_sims.pdf}
