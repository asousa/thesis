...
Figure \ref{fig:longitude_scaling_total} shows the average error across the entire stencil versus K$_p$ and longitude. On average, the 2D scaling factor overestimates power density by $\sim 15\%$.
\begin{figure}[h!]
\begin{center}
